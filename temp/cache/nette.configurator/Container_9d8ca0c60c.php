<?php
// source: C:\xampp\htdocs\Nette_databaze_vozu\app/config/common.neon
// source: C:\xampp\htdocs\Nette_databaze_vozu\app/config/local.neon
// source: array
...
class Container_9d8ca0c60c extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	protected $wiring = [
		...
		'Nette\Application\UI\IStatePersistent' => [2 => ['application.1', 'application.3', 'application.4', 'application.5']],
		'Nette\Application\UI\ISignalReceiver' => [2 => ['application.1', 'application.3', 'application.4', 'application.5']],
		...
		'App\Presenters\VodiciPresenter' => [2 => ['application.4']],
		'App\Presenters\VozyPresenter' => [2 => ['application.5']],
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\Nette_databaze_vozu\app',
			'wwwDir' => 'C:\xampp\htdocs\Nette_databaze_vozu\www',
			'vendorDir' => 'C:\xampp\htdocs\Nette_databaze_vozu\vendor',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\Nette_databaze_vozu\app/../temp',
		];
	}
	...
	public function createServiceApplication__4(): App\Presenters\VodiciPresenter
	{
		$service = new App\Presenters\VodiciPresenter($this->getService('database.default.context'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__5(): App\Presenters\VozyPresenter
	{
		$service = new App\Presenters\VozyPresenter($this->getService('database.default.context'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\Nette_databaze_vozu\app/../temp/cache/nette.application/touch'));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\Nette_databaze_vozu\app/../temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\IStorage
	{
		return new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\Nette_databaze_vozu\app/../temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_9d8ca0c60c
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=vozovy_park', 'root', null, []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_9d8ca0c60c $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\Nette_databaze_vozu\app/../temp/cache/latte');
