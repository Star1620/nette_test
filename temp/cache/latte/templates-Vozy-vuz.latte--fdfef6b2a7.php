<?php
// source: C:\xampp\htdocs\Nette_databaze_vozu\app\Presenters/templates/Vozy/vuz.latte

use Latte\Runtime as LR;

class Templatefdfef6b2a7 extends Latte\Runtime\Template
{
	public $blocks = [
...
?>
        <ul>
            ...
            <li>Zapůjčeno dne : <?php echo LR\Filters::escapeHtmlText(($this->filters->date)($kus->prirazeni_zacatek, 'j. n. Y')) /* line 18 */ ?></li><hr>
...
?>
    ...
    <button class="btn-primary"><a class='white' href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("upravit", [$kus->id_vozu])) ?>"> EDITOVAT </a></button>
